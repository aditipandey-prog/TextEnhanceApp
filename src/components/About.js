...
//});
 ...
 let myStyle={
  ...
  return (
    ...
    <h1 style={{color:props.mode==='dark'?'white':'#495057',backgroundColor:props.mode==='dark'?'#343a40':'white'}}>About Us</h1>
        ...
        <div className="accordion-item">
            ...
            Textutils gives you a way to analyze your text quickly and efficiently. Be it word count, character count or changing the case of your text.
            </div>
            </div>
        </div>
